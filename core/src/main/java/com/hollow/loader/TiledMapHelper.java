...
public class TiledMapHelper {
    ...
    public Vector2 findSpawnPoint(TiledMap map, float unitScale) {
        MapLayer layer = map.getLayers().get("logic");
    ...
    public Vector2 findBossSpawnPoint(TiledMap map, float unitScale) {
        MapLayer layer = map.getLayers().get("enemies");
    ...
    public Vector2 findZoteSpawnPoint(TiledMap map, float unitScale) {
