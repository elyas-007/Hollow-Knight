...
import com.hollow.views.ui.menu.AchievementsUI;
import com.hollow.views.ui.menu.BaseSettingUI;
import com.hollow.views.ui.menu.GuideUI;
import com.hollow.views.ui.menu.StartGameUI;
...
public class MainMenuScreen implements Screen, LanguageObserver {
    ...
    @Override
    public void show() {
        viewport = new FitViewport(HollowKnight.SCREEN_WIDTH, HollowKnight.SCREEN_HEIGHT);
    ...
    public void setupUI() {
        ...
        setupMenuButtons(rootTable, styleBtn);
        setupChangeBackgroundButton();
    }

    private void setupMenuButtons(Table rootTable, TextButtonStyle styleBtn) {
    ...
    private void setupChangeBackgroundButton() {
